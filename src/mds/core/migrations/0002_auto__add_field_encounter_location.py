...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encounter.location'
        db.add_column(u'core_encounter', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='6aa62e31-4e08-4fd3-bcd8-54c85f82dcb2', to=orm['core.Location'], to_field='uuid', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encounter.location'
        db.delete_column(u'core_encounter', 'location_id')
    ...
    models = {
        ...
        'core.concept': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'49dac4b7-0680-4387-b775-07d96d1c6f38'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.device': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'dcaff80b-4caa-4319-b76f-740446a50447'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.encounter': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'95909680-ffd5-4a58-81b1-cb25b3e005d3'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.event': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'5f71deca-29b1-48ef-a7a0-ff8abefdf5bf'", 'unique': 'True', 'max_length': '36'})
        },
        'core.instruction': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'d532b1d8-ecce-4e2e-96d1-881551866ada'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.location': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'a74b9dd5-8a97-43d5-915e-aeb765c3ea88'", 'unique': 'True', 'max_length': '36'})
        },
        'core.notification': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'71714e2d-5a44-419e-8898-72cd1b72f2a4'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.observation': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'b0126d94-4709-47f3-8abb-0383074f962f'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.observer': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'67c1566f-8b4b-4aaa-b96e-b5b5e89b2505'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.patient': {
        ...
        'core.procedure': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'cb5f31b2-00ba-4aaf-ae92-9e8b943166cd'", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.relationship': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'c44f55c1-3a8c-44d6-9688-2d0ad2cccef8'", 'unique': 'True', 'max_length': '36'})
        },
        'core.relationshipcategory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'8f1f79ed-7669-4d50-b8c3-905965d8f4fa'", 'unique': 'True', 'max_length': '36'})
        },
        'core.subject': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'ce49a85c-ff88-4af9-ae13-25c813dd4a74'", 'unique': 'True', 'max_length': '36'}),
            'voided': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        }
    }
